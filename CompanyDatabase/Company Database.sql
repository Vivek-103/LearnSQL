...
-- Find the First 5 employee 5 in thw table
SELECT * FROM employee
LIMIT 5;
...
--Find forename and sur-name of all employees
...
-- Find Total money spent by Client 
...
-- Find employees who are Schools
SELECT * 
FROM Client
...
--Find list of all clients and branch supplier name
